sap.ui.define([
	"sap/ui/test/Opa5",
	"worklist/app/BusinessITProject-WorklistApp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("worklist.app.BusinessITProject-WorklistApp.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "worklist.app.BusinessITProject-WorklistApp",
					async: true
				},
				hash: oOptions.hash,
