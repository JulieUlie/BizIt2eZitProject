sap.ui.define([
	...
	return BaseController.extend("worklist.app.BusinessITProject-WorklistApp.controller.Worklist", {
		...
		onUpdateStockObjects: function () {
			...
			if (aSelectedProducts.length) {
				...
				this._showErrorMessage(this.getModel("i18n").getResourceBundle().getText("Selecteer een item van de tabel"));
			}
		}
	});
});